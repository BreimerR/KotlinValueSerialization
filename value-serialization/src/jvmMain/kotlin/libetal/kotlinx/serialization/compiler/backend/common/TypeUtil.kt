...
import libetal.kotlinx.serialization.compiler.resolve.serialNameValue
...
import libetal.kotlinx.serialization.compiler.backend.jvm.enumSerializerId
import libetal.kotlinx.serialization.compiler.backend.jvm.referenceArraySerializerId
...
fun analyzeSpecialSerializers(
    ...
    annotations.hasAnnotation(SerializationAnnotations.contextualFqName) || annotations.hasAnnotation(
        SerializationAnnotations.contextualOnPropertyFqName) ->
