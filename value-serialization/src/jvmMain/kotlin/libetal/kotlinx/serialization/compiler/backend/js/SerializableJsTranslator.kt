...
import libetal.kotlinx.serialization.compiler.backend.js.*
import libetal.kotlinx.serialization.compiler.backend.common.anonymousInitializers
...
import libetal.kotlinx.serialization.compiler.resolve.bitMaskSlotAt
import libetal.kotlinx.serialization.compiler.resolve.getClassFromSerializationPackage
import libetal.kotlinx.serialization.compiler.resolve.isInternalSerializable
import libetal.kotlinx.serialization.compiler.resolve.isSerializationCtor
...
class SerializableJsTranslator(
    ...
    override fun generateInternalConstructor(constructorDescriptor: ClassConstructorDescriptor) {
        ...
        val missingExceptionClassRef = serializableDescriptor.getClassFromSerializationPackage(MISSING_FIELD_EXC)
            .constructors.single { it->it.valueParameters.size == 1 }
